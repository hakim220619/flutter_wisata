...
class ListWisataInPage extends ConsumerWidget {
  const ListWisataInPage({super.key});
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      InkWell(
                        child: const Text('Bengkalis', style: TextStyle(fontSize: 10),),
                        onTap: () {
                          ref
                              .watch(searchUserProvider.notifier)
                      ...
                      InkWell(
                        child: const Text('Dumai', style: TextStyle(fontSize: 10)),
                        onTap: () {
                          ref
                              .watch(searchUserProvider.notifier)
                      ...
                      InkWell(
                        child: const Text('Siak Sri Indrapura',  style: TextStyle(fontSize: 10)),
                        onTap: () {
                          ref
                              .watch(searchUserProvider.notifier)
