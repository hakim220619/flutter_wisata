...
final List<Reaction<String>> flagsReactions = [
  Reaction<String>(
    ...
    previewIcon: _buildFlagPreviewIcon(
      'assets/images/icon/united-kingdom-round.png',
      'English',
    ),
    icon: _buildFlagIcon(
      'assets/images/icon/united-kingdom.png',
    ),
  ),
  Reaction<String>(
    value: 'ar',
    previewIcon: _buildFlagPreviewIcon(
      'assets/images/icon/algeria-round.png',
      'Arabic',
    ),
    icon: _buildFlagIcon(
      'assets/images/icon/algeria.png',
    ),
  ),
  Reaction<String>(
    value: 'gr',
    previewIcon: _buildFlagPreviewIcon(
      'assets/images/icon/germany-round.png',
      'German',
    ),
    icon: _buildFlagIcon(
      'assets/images/icon/germany.png',
    ),
  ),
  Reaction<String>(
    value: 'sp',
    previewIcon: _buildFlagPreviewIcon(
      'assets/images/icon/spain-round.png',
      'Spanish',
    ),
    icon: _buildFlagIcon(
      'assets/images/icon/spain.png',
    ),
  ),
  Reaction<String>(
    value: 'ch',
    previewIcon: _buildFlagPreviewIcon(
      'assets/images/icon/china-round.png',
      'Chinese',
    ),
    icon: _buildFlagIcon(
      'assets/images/icon/china.png',
    ),
  ),
];
...
final List<Reaction<String>> reactions = [
  ...
  Reaction<String>(
    ...
    previewIcon: _buildEmojiPreviewIcon(
      'assets/images/icon/in-love.png',
    ),
    icon: _buildReactionsIcon(
      'assets/images/icon/in-love.png',
      const Text(
  ...
  Reaction<String>(
    ...
    previewIcon: _buildEmojiPreviewIcon(
      'assets/images/icon/surprised.png',
    ),
    icon: _buildReactionsIcon(
      'assets/images/icon/surprised.png',
      const Text(
